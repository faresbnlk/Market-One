...
(2, 'Pain', 'Pain dore Retrodor', 100, 1, 5, 1),
(3, 'Sucre', 'Sucre de canne.', 15, 2.24, 6, 1),
(4, 'Creme fraiche', 'Creme fraiche de Normandie', 50, 1.8, 6, 1),
...
(9, 'Voiture', 'Voiture a telecommande sans fil', 5, 25, 5, 3),
(10, 'Chemin de fer', 'Chemin de fer electrique', 4, 36, 5, 3);
